...
public class MemberInGroupTabDto {
    ...
    public static MemberInGroupTabDto of(MemberDto memberDto, MemberGrade grade) {
        return new MemberInGroupTabDto(null, null, memberDto, grade,null, null, null, null);
    }

    public static MemberInGroupTabDto of(Long groupTabId, MemberDto memberDto, MemberGrade grade) {
        return new MemberInGroupTabDto(null, groupTabId, memberDto, grade,null, null, null, null);
    }

    public static MemberInGroupTabDto of(Long id, Long groupTabId, MemberDto memberDto, MemberGrade grade,  LocalDateTime createdAt, String createdBy, LocalDateTime modifiedAt, String modifiedBy) {
        return new MemberInGroupTabDto(id, groupTabId, memberDto, grade, createdAt, createdBy, modifiedAt, modifiedBy);
    }

    public static MemberInGroupTabDto from(MemberGrade grade) {
